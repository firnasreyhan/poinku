                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <select name="ID_JENIS" class="form-control" id="exampleFormControlSelect1">
                                            ...
                                            ?>
                                                <option value="<?php echo $key->ID_JENIS ?>" <?php if($key->ID_JENIS == $detail_poin[0]->ID_JENIS) {echo 'selected';} ?>><?php echo $key->JENIS; ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <select name="ID_LINGKUP" class="form-control" id="exampleFormControlSelect1">
                                            ...
                                            ?>
                                                <option value="<?php echo $key->ID_LINGKUP ?>" <?php if($key->ID_LINGKUP == $detail_poin[0]->ID_LINGKUP) {echo 'selected';} ?>><?php echo $key->LINGKUP; ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <select name="ID_PERAN" class="form-control" id="exampleFormControlSelect1">
                                            ...
                                            ?>
                                                <option value="<?php echo $key->ID_PERAN ?>" <?php if($key->ID_PERAN == $detail_poin[0]->ID_PERAN) {echo 'selected';} ?>><?php echo $key->PERAN; ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
