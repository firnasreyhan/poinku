                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><a href="<?php echo site_url("riwayatTugasKhusus/detail/" . $detail_kegiatan[0]->NRP); ?>"><i class="fas fa-chevron-left"></i></a> Detail Kegiatan</h1>
                    &nbsp;
                    <!-- DataTales Example -->
