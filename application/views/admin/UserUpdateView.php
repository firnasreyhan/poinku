                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><a href="<?php echo site_url('user') ?>"><i class="fas fa-chevron-left"></i></a> Update Poin</h1>
                    &nbsp;
                            ...
                            <form action="<?php echo site_url("poin/update"); ?>" enctype="multipart/form-data" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input value="<?php echo $user[0]->EMAIL; ?>" type="text" class="form-control" name="EMAIL" placeholder="Email" disabled>
                                    </div>
                                    <div class="form-group">
