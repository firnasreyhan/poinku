                            ...
                            <form action="<?php echo site_url("aturan/update"); ?>" enctype="multipart/form-data" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input value="<?php echo $detail_aturan[0]->TAHUN; ?>" type="text" class="form-control" name="TAHUN" placeholder="Tahun" required>
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $detail_aturan[0]->KETERANGAN; ?>" type="text" class="form-control" name="KETERANGAN" placeholder="Keterangan" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <input value="<?php echo $detail_aturan[0]->ID_ATURAN; ?>" type="hidden" class="form-control" name="ID_ATURAN" placeholder="Keterangan" id="INPUT_ID_ATURAN">
